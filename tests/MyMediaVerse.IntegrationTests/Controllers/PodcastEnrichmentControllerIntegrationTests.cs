...
{
    public class PodcastEnrichmentControllerIntegrationTests : IClassFixture<WebApplicationFactory>
    {
        ...
        public PodcastEnrichmentControllerIntegrationTests(WebApplicationFactory factory)
        {
            _factory = factory;
