...
namespace MyMediaVerse.IntegrationTests.Api
{
    ...
    /// - "Unclassified": carries neither attribute.
    /// </summary>
    [Collection("Database")]
    public class AuthorizationModelTests
    {
        ...
        private static readonly IReadOnlyDictionary<string, string> ExpectedClassifications =
            new Dictionary<string, string>
            {
                ...
                ["Demo.Lock"] = Unclassified,
                ["Demo.Status"] = Unclassified,
                ["Demo.Unlock"] = Unclassified,
                ...
                ["Health.CorsTest"] = Unclassified,
                ["Health.Get"] = Unclassified,
                ["Health.GetDetailed"] = Unclassified,
                ...
                ["Media.ExportAllMedia"] = Anonymous,
                ["Media.ExportMediaItem"] = Anonymous,
                ["Media.GetAllMedia"] = Anonymous,
                ["Media.GetMediaByGenre"] = Anonymous,
                ["Media.GetMediaByTopic"] = Anonymous,
                ["Media.GetMediaByType"] = Anonymous,
                ["Media.GetMediaItem"] = Anonymous,
                ["Media.SearchMedia"] = Anonymous,
                ["Media.UpdateMediaItem"] = Unclassified,
                ["Mixlist.AddMediaItemToMixlist"] = Anonymous,
                ["Mixlist.CreateMixlist"] = Anonymous,
                ["Mixlist.DeleteMixlist"] = Anonymous,
                ["Mixlist.ExportAllMixlists"] = Anonymous,
                ["Mixlist.ExportMixlist"] = Anonymous,
                ["Mixlist.GetAllMixlists"] = Anonymous,
                ["Mixlist.GetMixlist"] = Anonymous,
                ["Mixlist.GetNotesForMixlist"] = Anonymous,
                ["Mixlist.ImportMixlists"] = Anonymous,
                ["Mixlist.LinkNoteToMixlist"] = Anonymous,
                ["Mixlist.RemoveMediaItemFromMixlist"] = Anonymous,
                ["Mixlist.SearchMixlists"] = Anonymous,
                ["Mixlist.UnlinkNoteFromMixlist"] = Anonymous,
                ["Mixlist.UpdateMixlist"] = Anonymous,
                ...
                ["Note.Create"] = Authorized,
                ["Note.Delete"] = Authorized,
                ["Note.GetAll"] = Anonymous,
                ["Note.GetById"] = Anonymous,
                ["Note.GetBySlug"] = Anonymous,
                ["Note.GetMediaForNote"] = Anonymous,
                ["Note.GetNotesForMedia"] = Anonymous,
                ["Note.GetSyncStatus"] = Authorized,
                ["Note.LinkToMedia"] = Authorized,
                ["Note.SyncAll"] = Authorized,
                ["Note.SyncVault"] = Authorized,
                ["Note.UnlinkFromMedia"] = Authorized,
                ["Note.Update"] = Authorized,
                ...
                ["RelatedMedia.GetRelatedMedia"] = Anonymous,
                ["RelatedMedia.RemoveRelatedMedia"] = Anonymous,
                ["RelatedMedia.SaveRelatedMedia"] = Anonymous,
                ["RelatedMedia.SaveRelatedMediaBatch"] = Anonymous,
                ["Search.Health"] = Anonymous,
