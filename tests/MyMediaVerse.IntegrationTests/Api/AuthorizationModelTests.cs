    ...
    public class AuthorizationModelTests
    {
        ...
        private static readonly IReadOnlyDictionary<string, string> ExpectedClassifications =
            new Dictionary<string, string>
            {
                ...
                ["Article.BulkFetchContent"] = Authorized,
                ["Article.CreateArticle"] = Unclassified,
                ["Article.DeduplicateArticles"] = Authorized,
                ["Article.DeleteArticle"] = Unclassified,
                ["Article.FetchArticleContent"] = Authorized,
                ["Article.FetchByReaderDocumentId"] = Authorized,
                ["Article.FindDuplicates"] = Authorized,
                ...
                ["Article.GetArticlesWithReaderDocumentIds"] = Authorized,
                ["Article.GetReaderDocuments"] = Authorized,
                ["Article.GetStarredArticles"] = Unclassified,
                ["Article.ScrapePreview"] = Authorized,
                ["Article.SyncFromReader"] = Authorized,
                ["Article.TestFetchReaderDocument"] = Authorized,
                ...
                ["Book.ImportFromGoogleBooks"] = Authorized,
                ["Book.ImportFromOpenLibrary"] = Authorized,
                ...
                ["Highlight.ExportHighlight"] = Authorized,
                ...
                ["Highlight.LinkHighlightsToMedia"] = Authorized,
                ...
                ["Movie.ImportMovieFromTmdb"] = Authorized,
                ...
                ["Podcast.ImportEpisodeFromFeed"] = Authorized,
                ["Podcast.ImportPodcastsFromOpml"] = Authorized,
                ["Podcast.ImportSeriesFromFeed"] = Authorized,
                ["Podcast.SearchDirectory"] = Unclassified,
                ["Podcast.SearchPodcastSeries"] = Unclassified,
                ["Podcast.SubscribeToPodcastSeries"] = Unclassified,
                ["Podcast.SyncAllSubscribedSeries"] = Authorized,
                ["Podcast.SyncPodcastSeriesEpisodes"] = Authorized,
                ...
                ["Readwise.SyncAll"] = Authorized,
                ["Readwise.ValidateConnection"] = Authorized,
                ...
                ["Website.EnrichWebsite"] = Authorized,
                ["Website.ExportBookmarks"] = Authorized,
                ...
                ["Website.ImportBookmarkFile"] = Authorized,
                ["Website.ImportUrlList"] = Authorized,
                ["Website.ImportWebsite"] = Authorized,
                ["Website.PreviewBookmarkFile"] = Authorized,
                ["Website.PreviewUrlList"] = Authorized,
                ["Website.RegenerateScreenshot"] = Authorized,
                ["Website.ScrapePreview"] = Authorized,
                ["Website.UpdateWebsite"] = Unclassified,
                ["WebsiteEnrichment.CheckLinks"] = Authorized,
                ["WebsiteEnrichment.GetStatus"] = Authorized,
                ["WebsiteEnrichment.RepairThumbnails"] = Authorized,
                ["WebsiteEnrichment.RunEnrichment"] = Authorized,
