...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectLoopbreaker.Domain.Entities.MediaItemNote", b =>
                {
                    b.Property<Guid>("MediaItemId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProjectLoopbreaker.Domain.Entities.MixlistNote", b =>
                {
                    b.Property<Guid>("MixlistId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProjectLoopbreaker.Domain.Entities.TraktToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProjectLoopbreaker.Domain.Entities.Document", b =>
                {
                    b.HasBaseType("ProjectLoopbreaker.Domain.Entities.BaseMediaItem");
            ...
            modelBuilder.Entity("ProjectLoopbreaker.Domain.Entities.TvShowEpisode", b =>
                {
                    b.HasBaseType("ProjectLoopbreaker.Domain.Entities.BaseMediaItem");
            ...
            modelBuilder.Entity("ProjectLoopbreaker.Domain.Entities.MediaItemNote", b =>
                {
                    b.HasOne("ProjectLoopbreaker.Domain.Entities.BaseMediaItem", "MediaItem")
                        .WithMany()
                        .HasForeignKey("MediaItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjectLoopbreaker.Domain.Entities.Note", "Note")
            ...
            modelBuilder.Entity("ProjectLoopbreaker.Domain.Entities.MixlistNote", b =>
                {
                    b.HasOne("ProjectLoopbreaker.Domain.Entities.Mixlist", "Mixlist")
            ...
            modelBuilder.Entity("ProjectLoopbreaker.Domain.Entities.Document", b =>
                {
                    b.HasOne("ProjectLoopbreaker.Domain.Entities.BaseMediaItem", null)
                        .WithOne()
                        .HasForeignKey("ProjectLoopbreaker.Domain.Entities.Document", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ProjectLoopbreaker.Domain.Entities.TvShowEpisode", b =>
                {
                    b.HasOne("ProjectLoopbreaker.Domain.Entities.BaseMediaItem", null)
                        .WithOne()
                        .HasForeignKey("ProjectLoopbreaker.Domain.Entities.TvShowEpisode", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjectLoopbreaker.Domain.Entities.TvShow", "Show")
                        .WithMany("Episodes")
